                    ...
                    <form action="<?= base_url('auth/signup') ?>" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group password-group">
                                <span class="input-group-text">🔒</span>
                                <input type="password" name="password" class="form-control border-end-0" placeholder="Create a password" required>
                                <span class="input-group-text bg-white border-start-0 toggle-password">👁</span>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group password-group">
                                <span class="input-group-text">🔒</span>
                                <input type="password" name="confirm_password" class="form-control border-end-0" placeholder="Confirm your password" required>
                                <span class="input-group-text bg-white border-start-0 toggle-password">👁</span>
                            </div>
                        </div>
